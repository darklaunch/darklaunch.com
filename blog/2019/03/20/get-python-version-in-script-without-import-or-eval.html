<p>Find variable assignments in a python file using the ast module without executing the file.</p>

<p>Given any of the following 3 files, we can find the value of the "VERSION" variable.</p>
